...
namespace CalculatorEngine
{
    static class Mathematics
    {
        ...
        public static Matrix4 CreateTransformationMatrix(Transform transform)
        {
            Matrix4 r1 = Matrix4.CreateRotationX(transform.xAxisRotation);
            Matrix4 r2 = Matrix4.CreateRotationY(transform.yAxisRotation);
            Matrix4 r3 = Matrix4.CreateRotationZ(transform.zAxisRotation);
